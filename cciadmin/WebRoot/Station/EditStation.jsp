    ...
    <tr>
      ...
      <tr>
        ...
        <td width="25%" bgcolor="#FFFFFF">
					...
					<s:if test="station.station_type==2">VHF_JRC</s:if>
      ...
      <tr>
        ...
        <td width="25%" bgcolor="#FFFFFF">
				<s:textfield name="station.server_ip"
								value="%{station.server_ip}" id="station.server_ip" theme="simple"></s:textfield>
		</td>
        <td width="25%" align="right" bgcolor="#FFFFFF">服务端口</td>
        <td width="25%" bgcolor="#FFFFFF">
		<s:textfield name="station.server_port"
								value="%{station.server_port}" id="station.server_port" theme="simple"></s:textfield>
		</td>
      </tr>
      <tr>
